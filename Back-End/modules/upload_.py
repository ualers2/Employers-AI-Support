...
def upload_(name_project, VIDEO_FILE_PATH, USER_ID_FOR_TEST):
    ...
    if UPLOAD_URL == None:
        load_dotenv(os.path.join(diretorio_script, '../', 'modules', 'Keys', 'keys.env'))
        UPLOAD_URL = os.getenv("UPLOAD_URL")
    video_metadata = {
...
if __name__ == '__main__':
    save_path = r"E:\Users\Media Cuts DeV\Downloads\HomeServer\HomeServer\Docs\Support\Informações Técnicas.md"
