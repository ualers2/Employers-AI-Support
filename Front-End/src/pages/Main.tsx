            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex items-center justify-between bg-white rounded-lg shadow-sm p-6">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">Controle completo das IAs de suporte inteligente</p>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium">Respostas das IAs</CardTitle>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">Arquivos das IAs</p>
                        </CardContent>
                    </Card>
                </div>
